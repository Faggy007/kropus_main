...
return [
    ...
    */
     ...
     */
    'theme' => env('COOKIE_CONSENT_THEME', 'custom'),
     ...
     */
    'cookie_description' => "Этот сайт использует файлы cookie для улучшения вашего опыта работы с сайтом, анализа трафика и персонализации контента. Продолжая использовать этот сайт, вы соглашаетесь с использованием файлов cookie.",
     ...
     * @default 'Accept all'
     */
    'cookie_accept_btn_text' => 'Принять все',
     ...
     * @default 'Reject all'
     */
    'cookie_reject_btn_text' => 'Отклонить все',
     ...
     */
    'cookie_preferences_btn_text' => 'Настроить предпочтения',
     ...
     */
    'cookie_preferences_save_text' => 'Сохранить настройки',
     ...
     */
    'cookie_modal_title' => 'Настройки файлов cookie',
     ...
     */
    'cookie_modal_intro' => 'Вы можете настроить свои предпочтения в отношении файлов cookie ниже.',
    ...
    'cookie_categories' => [
        'necessary' => [
            ...
            'locked' => true,
            'title' => 'Необходимые',
            'description' => 'Эти файлы cookie необходимы для работы сайта и не могут быть отключены в наших системах. Обычно они устанавливаются только в ответ на действия, которые вы предприняли, когда запросили услуги, например, настройки конфиденциальности, вход в систему или заполнение форм.',
        ],
        'analytics' => [
            'enabled' => true,
            'locked' => false,
            ...
            'title' => 'Аналитические',
            'description' => 'Эти файлы cookie позволяют нам считать посещения и источники трафика, чтобы мы могли измерить и улучшить производительность нашего сайта. Они помогают нам понять, какие страницы наиболее и наименее популярны, и видеть, как посетители перемещаются по сайту. Если вы не разрешите эти файлы cookie, мы не будем знать, когда вы посетили наш сайт.',
        ],
        'marketing' => [
